...
// // //       newHead[0] < 0 ||
// // //       newHead[1] < 0 ||
// // //       newHead[0] >= gridWidth || // Hits right boundary
...
// // //     ) {
// // //       setGameOver(true);
// // //       setGameStarted(false); // Stop the game when over
// // //     } else {
// // //       setSnake(newSnake);
// // //     }
// // //   };
...
// //   const changeDirection = (e) => {
// //     const key = e.key || e.target.name; // Handles both keyboard and button clicks
// //     switch (key) {
// //       case "ArrowUp":
// //       case "UP":
// //         if (direction !== "DOWN") setDirection("UP");
...
// //               </button>
// //             </div>
// //             <button name="DOWN" onClick={changeDirection}>
// //               ↓
// //             </button>
// //           </div>
// //         </div>
...
const SnakeGame = ({ onSkip }) => {
  ...
  useEffect(() => {
    if (score === 10) {
      onSkip(); // Automatically skip the game when score reaches 10
    }
  }, [score, onSkip]);
